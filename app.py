...
def output():
    ...
    if twitter_account.shape[0]==0:
        ...
        plot = figure(x_range=x, plot_height=350, toolbar_location=None, tools="")
        ...
        return render_template('pages/output.html',\
            screen_name=screen_name, placeholder_name=placeholder_name, worst_tweet=notable, the_div=div, the_script=script)
